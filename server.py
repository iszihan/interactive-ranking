...
sys.path.append('/scratch/ondemand29/chenxil/code/mood-board/search_benchmark')
...
CONFIG_PATH = '/scratch/ondemand29/chenxil/code/mood-board/search_benchmark/pair_experiments_0704/small_benchmark_0704_p1.yml'
import torch
...
class Engine:
    ...
    def start(self) -> None:
        ...
        src_dir = Path('/scratch/ondemand29/chenxil/code/mood-board/search_benchmark/pair_experiments_0704/_s00/')
        if src_dir.exists():
